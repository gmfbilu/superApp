...
public class JsBridgeWebViewClient extends WebViewClient {
    ...
    public JsBridgeWebViewClient(ProgressBar bar, TextView title, TextView close) {
        this(bar, title, close, true);
    }

    public JsBridgeWebViewClient(ProgressBar bar, TextView title, TextView close, boolean isAppOpen) {
        mProgressBar = bar;
        mTitle = title;
        this.mClose = close;
