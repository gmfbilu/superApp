...
public class DetailFragment extends BaseFragment {
    ...
    public void findViewById_setOnClickListener(View view) {
        mToolbar = view.findViewById(R.id.module_fragment_toolbar);
        view.findViewById(R.id.module_fragment_fab).setOnClickListener(this);
        mTvContent = view.findViewById(R.id.module_fragment_tv_content);
        mToolbar.setTitle(mTitle);
    }

    @Override
    public int setLayout() {
        return R.layout.module_fragment_fragment_tab_third_detail;
    }
    ...
    public void onEnterAnimationEnd(Bundle savedInstanceState) {
        mTvContent.setText(R.string.module_fragment_large_text);
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.module_fragment_fab) {
