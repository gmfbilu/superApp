...
public class MainFragment extends BaseFragment {
    ...
    public void findViewById_setOnClickListener(View view) {
        ...
        mBottomBar
                .addItem(new BottomBarTab(_mActivity, R.mipmap.module_fragment_ic_message_white_24dp, "消息"))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.module_fragment_ic_account_circle_white_24dp, "发现"))
                .addItem(new BottomBarTab(_mActivity, R.mipmap.module_fragment_ic_discover_white_24dp, "更多"));
    ...
    public int setLayout() {
        return R.layout.module_fragment_fragment_main;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (firstFragment == null) {
            ...
            loadMultipleRootFragment(R.id.module_fragment_fl_tab_container, FIRST,
                    mFragments[FIRST],
                    mFragments[SECOND],
                    mFragments[THIRD]);
        } else {
