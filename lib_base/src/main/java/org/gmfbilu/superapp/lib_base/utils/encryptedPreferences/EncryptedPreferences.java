package org.gmfbilu.superapp.lib_base.utils.encryptedPreferences;
 ...
 *
 *  EncryptedPreferences encryptedPreferences = new EncryptedPreferences.Builder(App.Companion.getMApp()).withEncryptionPassword(Constant.SP_INFO_PASSWORD).build();
 *  encryptedPreferences.edit().putString(Constant.SP_INFO_SERVICEPHONE,servicePhone.getData()).apply();
 *
 *  encryptedPreferences.getString(Constant.SP_INFO_ORGINTRO, "");
 */
