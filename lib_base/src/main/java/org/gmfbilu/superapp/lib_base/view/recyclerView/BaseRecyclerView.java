...
public class BaseRecyclerView extends FrameLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mPadding = (int) a.getDimension(R.styleable.BaseRecyclerView_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.BaseRecyclerView_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.BaseRecyclerView_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.BaseRecyclerView_recyclerPaddingLeft, 0.0f);
            ...
            mErrorId = a.getResourceId(R.styleable.BaseRecyclerView_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        adapter.registerAdapterDataObserver(new BaseDataObserver(this));
        showRecycler();
    }
