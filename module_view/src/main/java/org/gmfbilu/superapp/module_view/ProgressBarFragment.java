...
public class ProgressBarFragment extends BaseFragment {
    ...
    public void findViewById_setOnClickListener(View view) {
        ...
        mCircleProgressBar = view.findViewById(R.id.view_circleProgressBar);
        mHorizontalProgressBar = view.findViewById(R.id.view_horizontalProgressBar);
    }

    @Override
    public int setLayout() {
        return R.layout.view_fragment_progressbar;
    }
