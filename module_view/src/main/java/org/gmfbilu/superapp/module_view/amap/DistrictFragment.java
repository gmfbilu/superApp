...
public class DistrictFragment extends BaseFragment  implements DistrictSearch.OnDistrictSearchListener, AdapterView.OnItemSelectedListener{
    ...
    public void findViewById_setOnClickListener(View view) {
        tv_countryInfo = (TextView) view.findViewById(R.id.tv_countryInfo);
        tv_provinceInfo = (TextView) view.findViewById(R.id.tv_provinceInfo);
        tv_cityInfo = (TextView) view.findViewById(R.id.tv_cityInfo);
        tv_districtInfo = (TextView) view.findViewById(R.id.tv_districtInfo);
    ...
    public int setLayout() {
        return R.layout.module_view_fragment_district;
    }
    ...
    public void onDistrictSearched(DistrictResult result) {
        ...
        if (result != null) {
            if (result.getAMapException().getErrorCode() == AMapException.CODE_AMAP_SUCCESS) {
                ...
                ToastUtil.show(result.getAMapException().getErrorCode()+"");
            }
        }
    ...
    private void setSpinnerView(List<DistrictItem> subDistrictList) {
        ...
        if (subDistrictList != null && subDistrictList.size() > 0) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String>(_mActivity, android.R.layout.simple_spinner_item, nameList);
    ...
    private void init() {
        // 设置行政区划查询监听
        DistrictSearch districtSearch = new DistrictSearch(_mActivity);
