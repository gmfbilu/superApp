package org.gmfbilu.superapp.module_view.fragment.views;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.module_view_tab_unselected));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.module_view_tab_unselected));
        ...
        mTvUnreadCount.setBackgroundResource(R.drawable.module_view_shape_msg_bubble);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.module_view_tab_unselected));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.module_view_tab_unselected));
        }
    }
