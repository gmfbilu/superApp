...
import org.gmfbilu.superapp.module_view.kLine.tifezh.kchartlib.entity.IKLine;
import org.gmfbilu.superapp.module_view.kLine.tifezh.kchartlib.formatter.TimeFormatter;
...
public abstract class BaseKChartView extends ScrollAndScaleView {
    ...
    private void init() {
        ...
        mTopPadding = (int) getResources().getDimension(R.dimen.tifezh_chart_top_padding);
        mBottomPadding = (int)getResources().getDimension(R.dimen.tifezh_chart_bottom_padding);
