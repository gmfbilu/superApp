...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
         ...
         * 设置自定义属性
         */
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.view_CircleProgressBar);
        progressWidth = typedArray.getDimensionPixelOffset(R.styleable.view_CircleProgressBar_view_progressWidth, progressWidth);
        progressColor = typedArray.getColor(R.styleable.view_CircleProgressBar_view_progressColor, progressColor);
        duration = typedArray.getInteger(R.styleable.view_CircleProgressBar_view_circleAnimationDuration, duration);
        isDrawCenterProgressText = typedArray.getBoolean(R.styleable.view_CircleProgressBar_view_isDrawCenterProgressText, isDrawCenterProgressText);
        typedArray.recycle();
