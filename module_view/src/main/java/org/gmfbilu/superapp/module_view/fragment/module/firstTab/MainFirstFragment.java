...
public class MainFirstFragment extends BaseMainFFragment {
    ...
    public void findViewById_setOnClickListener(View view) {
        ...
        view.findViewById(R.id.module_view_tv_go).setOnClickListener(this);
    }

    @Override
    public int setLayout() {
        return R.layout.module_view_fragment_tab_first;
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.module_view_tv_go) {
            ...
            ((MainFFragment) getParentFragment()).start(OneLayerFragment.newInstance(new Message("hello")));
    ...
    public void onTabSelectedEvent(TabSelectedEvent event) {
        if (event.position != MainFFragment.FIRST) return;
