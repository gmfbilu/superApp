...
import org.gmfbilu.superapp.module_view.kLine.tifezh.kchartlib.entity.IMinuteLine;
import org.gmfbilu.superapp.module_view.kLine.tifezh.kchartlib.formatter.BigValueFormatter;
...
public class MinuteChartView extends View implements GestureDetector.OnGestureListener {
    ...
    private void init() {
        ...
        mVolumePaintGreen.setColor(ContextCompat.getColor(getContext(), R.color.tifezh_chart_green));
        mVolumePaintRed.setColor(ContextCompat.getColor(getContext(),R.color.tifezh_chart_red));
